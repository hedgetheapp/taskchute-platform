...
CREATE TABLE operations_duplicate_entry (
  app_user_id TEXT NOT NULL,
  operation_id TEXT NOT NULL,
  command_type TEXT NOT NULL CHECK (command_type IN (
    'CreateProject', 'AddTaskToDay', 'ReorderEntries', 'StartEntry', 'CompleteEntry', 'DuplicateEntry',
...
INSERT INTO operations_duplicate_entry SELECT * FROM operations;
DROP TABLE operations;
ALTER TABLE operations_duplicate_entry RENAME TO operations;
