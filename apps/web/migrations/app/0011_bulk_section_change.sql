...
CREATE TABLE operations_bulk_section_change (
...
INSERT INTO operations_bulk_section_change SELECT * FROM operations;
DROP TABLE operations;
ALTER TABLE operations_bulk_section_change RENAME TO operations;
