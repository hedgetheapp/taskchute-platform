...
-- D-086 extends the existing typed schedule relation in place. Legacy rows are
-- copied without reinterpretation; routine_definitions.recurrence_type and all
-- occurrence/history identities remain untouched.
CREATE TABLE routine_schedules_d086 (
...
INSERT INTO routine_schedules_d086
...
SELECT app_user_id, routine_definition_id, schedule_kind, interval_days, NULL,
       NULL, weekdays_mask, NULL, NULL, NULL
  FROM routine_schedules;

DROP TABLE routine_schedules;
ALTER TABLE routine_schedules_d086 RENAME TO routine_schedules;
