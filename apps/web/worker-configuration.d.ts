/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 56abae52c681331ffb76f3983d0b95e4)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 
interface __BaseEnv_Env {
	AUTH_DB: D1Database;
	APP_DB: D1Database;
	RUNTIME_ENV: "nonprod" | "production" | "local";
	BOOTSTRAP_ENABLED: string;
	BETTER_AUTH_SECRET: string;
	REALTIME_HUB?: DurableObjectNamespace<import("./worker/index").RealtimeHub>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RUNTIME_ENV" | "BOOTSTRAP_ENABLED" | "BETTER_AUTH_SECRET">> {}
}
