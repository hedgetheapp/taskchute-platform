...
- Exact nonprod deployはWorker `taskchute-web-nonprod` version `8ff2080f-afe6-48b9-a5ac-fdfba05d6a45`（`RUNTIME_ENV=nonprod`、`BOOTSTRAP_ENABLED=false`、既存APP/AUTH binding）を使用。root `200`、protected current API `401`、bootstrap `401`を確認した。
