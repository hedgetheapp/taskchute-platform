...
| D101-WORKER | Task Primary commands | owner-scoped Ensure/Update, exact replay/misuse, atomic relation+Document Create, revision CAS, concurrent Ensure convergence, same-result stale Update rejection, shared permalink resolver | Documents/Task Primary integration `23 / 23` | PASS |
