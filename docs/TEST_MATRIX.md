...
| D071-ENV-01 | Persistent nonprod | exact main deploy、authenticated visual / interaction、reload order persistence、console、APP/AUTH read-only integrity | deploy pending | NOT_RUN |
